...
#'   (catalán). Se pasa a \code{\link{count_syllables}} y a
#'   \code{\link{count_words}}. Si no se especifica, se usa
...
letters_per_word <- function(text,
  ...
  tokens_list <- tokenize_words(text_safe, lang = lang, ...)
